...
function k(e, n, o, a) {
    let i, s, c, l, u = t(e);
    if (e instanceof Map ? e instanceof e.constructor ? (i = `Map(${e.size})`, s = L) : (i = "Map()", s = U) : e instanceof Set ? e instanceof e.constructor ? (i = `Set(${e.size})`, s = M) : (i = "Set()", s = U) : u ? (i = `${e.constructor.name}(${e.length})`, s = R) : (l = m(e)) ? (i = `Immutable.${l.name}${"Record" === l.name ? "" : `(${e.size})`}`, u = l.arrayish, s = l.arrayish ? P : l.setish ? I : D) : (i = d(e), s = U), n) {
        const t = document.createElement("span");
...
function tt(e = "https://cdn.jsdelivr.net/npm/", t = ["unpkg", "jsdelivr", "browser", "main"]) {
    ...
    return async function (r, o) {
        ...
        if (a.path && !Qe.test(a.path) && (a.path += ".js"), a.path && a.version && Xe.test(a.version)) return `${e}${a.name}@${a.version}/${a.path}`;
        const i = await n(a);
        return `${e}${i.name}@${i.version}/${a.path || function (e) { for (const n of t) { let t = e[n]; if ("string" == typeof t) return t.startsWith("./") && (t = t.slice(2)), Qe.test(t) ? t : `${t}.js` } }(i) || "index.js"}`
    }
}
...
function st(e, t, n) {
    ...
    r < 2 ? (n = e, t = []) : r < 3 && (n = t, t = "string" == typeof e ? [] : e), Ve.push(Ze.call(t, it) ? e => {
        const r = {},
            o = {
                exports: r
            };
        return Promise.all(Ye.call(t, (t => "exports" === (t += "") ? r : "module" === t ? o : e(t)))).then((e => (n.apply(null, e), o.exports)))
...
var At = Object.freeze({
    ...
    element: function (e, t) {
        ...
        if (t)
            for (var i in t) o = (r = i).indexOf(":"), n = t[i], o >= 0 && "xmlns" !== (r = i.slice(0, o)) && (i = i.slice(o + 1)), Ct.hasOwnProperty(r) ? a.setAttributeNS(Ct[r], i, n) : a.setAttribute(i, n);
        return a
    },
    input: function (e) {
...
class DuckDBClient {
    ...
    async describeColumns({
        ...
        return (await this.query(`DESCRIBE ${e}`)).map((({
            column_name: e,
            column_type: t,
            null: n
        }) => ({
    ...
    static async of(e = {}, t = {}) {
        ...
        return void 0 === t.query?.castTimestampToDate && (t = {
            ...
            if (t instanceof FileAttachment) await Pt(n, e, t);
                ...
                Lt(r) ? await Rt(n, e, r, o) : await Ut(n, e, r, o)
            } else {
...
async function Rt(e, t, n, r) {
    const o = (await Dt()).tableToIPC(n),
        a = await e.connect();
    try {
        await a.insertArrowFromIPCStream(o, {
            name: t,
            schema: "main",
            ...r
        })
...
async function Ut(e, t, n, r) {
    const o = (await Dt()).tableFromJSON(n);
    return await Rt(e, t, o, r)
}
async function Dt() {
...
function Bt(e, t) {
    return function (n) {
        ...
        if (p = e(f), ++h > 0) {
            for (a = new Array(h), i = document.createTreeWalker(p, NodeFilter.SHOW_COMMENT, null, !1); i.nextNode();) o = i.currentNode, /^o:/.test(o.nodeValue) && (a[+o.nodeValue.slice(2)] = o);
...
const sn = Object.assign((async (e, t, n) => {
    if (e = await cn(await e, "table"), (r = e) && ("function" == typeof r.sql || "function" == typeof r.queryTag && ("function" == typeof r.query || "function" == typeof r.queryStream)) && ("table" !== o || "function" == typeof r.describeColumns) && r !== sn) return ln(e, function (e, t) {
        ...
        const c = [
            [`SELECT ${r.columns ? r.columns.map((e => `t.${n(e)}`)) : "*"} FROM ${un(o.table, n)} t`]
        ];
        for (let e = 0; e < a.length; ++e) fn(e ? "\nAND " : "\nWHERE ", c), pn(a[e], c, n);
        for (let e = 0; e < i.length; ++e) fn(e ? ", " : "\nORDER BY ", c), dn(i[e], c, n);
        if ("mssql" === t.dialect) {
    ...
    sql: (e, t) => async function () {
        return ln(await cn(await e, "sql"), arguments, t)
    }
});
...
function pn({
    ...
    if (1 === t.length) switch (hn(t[0], n, r), e) {
        case "n":
            return void fn(" IS NULL", n);
        case "nn":
            return void fn(" IS NOT NULL", n);
        default:
    ...
    if (2 !== t.length || ["in", "nin"].includes(e)) {
        ...
        switch (hn(t[0], n, r), e) {
            ...
            let n = !0;
            for (const r of e) n ? n = !1 : fn(",", t), t.push(r.value), t[0].push("")
        }(t.slice(1), n), fn(")", n)
    } else {
        if (["c", "nc"].includes(e)) {
            switch (hn(t[0], n, r), e) {
...
function hn(e, t, n) {
    "column" === e.type ? fn(`t.${n(e.value)}`, t) : (t.push(e.value), t[0].push(""))
}
const Library = Object.assign(Object.defineProperties((function (e) {
    ...
    Object.defineProperties(this, (n = {
        ...
        svg: () => Jt,
        tex: () => function (e) {
            return Promise.all([e($e.resolve()), e.resolve($e.resolve("dist/katex.min.css")).then(Xt)]).then((function (e) {
                var t = e[0],
                    n = r();
        ...
        Generators: kt,
        Promises: Yt
    }, Object.fromEntries(Object.entries(n).map(mn))))
}), {
    resolve: {
        get: () => lt.resolve,
        enumerable: !0,
...
function yn() { }
const _n = Symbol("no-observer");

function Variable(e, t, n) {
    var r;
    n || (n = _n), Object.defineProperties(this, {
        _observer: {
            value: n,
            writable: !0
        },
...
function Tn(e, t, n) {
    ...
    if (this._inputs.forEach(En, this), t.forEach(gn, this), this._inputs = t, this._definition = n, this._value = void 0, n === yn ? o._variables.delete(this) : o._variables.add(this), e !== this._name || r.get(e) !== this) {
        let t, a;
        if (this._name)
        ...
        e && ((a = r.get(e)) ? 3 === a._type ? (this._definition = Nn(e), this._duplicate = n, a._duplicates.add(this)) : 2 === a._type ? (this._outputs = a._outputs, a._outputs = new Set, this._outputs.forEach((function (e) {
            e._inputs[e._inputs.indexOf(a)] = this
        }), this), o._dirty.add(a).add(this), r.set(e, this)) : (a._duplicate = a._definition, this._duplicate = n, t = new Variable(3, this._module), t._name = e, t._definition = this._definition = a._definition = Nn(e), t._outputs = a._outputs, a._outputs = new Set, t._outputs.forEach((function (e) {
...
Object.defineProperties(Variable.prototype, {
    ...
    define: {
        value: function (e, t, n) {
            ...
            return Tn.call(this, null == e ? null : String(e), null == t ? [] : wn.call(t, this._module._resolve, this._module), "function" == typeof n ? n : bn(n))
        },
        writable: !0,
        configurable: !0
    },
    ...
    import: {
        value: function (e, t, n) {
            ...
            return Tn.call(this, String(t), [n._resolve(String(e))], vn)
        },
        writable: !0,
        configurable: !0
    }
});
const An = Symbol("variable"),
    jn = Symbol("invalidation"),
    $n = Symbol("visibility");
...
Object.defineProperties(Module.prototype, {
            ...
            for (const e of r)
                ...
                for (const [r, o] of t._scope) {
                    ...
                    if (!t || 2 === t._type)
                        ...
                        } else e.define(r, o._inputs.map(Sn), o._definition)
                }
            return i
        },
        writable: !0,
    ...
    value: {
        value: async function (e) {
            ...
            try {
                return await qn(this._runtime, t)
            } finally {
                t.delete()
            }
        },
...
function Runtime(e = new Library, t = Fn) {
    const n = this.module();
...
function Un(e) {
    ...
    const t = e._value,
        n = ++e._version;
    let r = null;
    const o = e._promise = (e._inputs.length ? Promise.all(e._inputs.map(In)).then((function (o) {
        ...
        }(t)) return (r || Pn(e)).then((o = t, function () {
            o.return()
        })),
            function (e, t, n) {
...
Object.defineProperties(Runtime.prototype, {
    ...
    _computeSoon: {
        value: function () {
            return new Promise(On).then((() => this._disposed ? void 0 : this._computeNow()))
        },
        writable: !0,
        configurable: !0
    },
    _computeNow: {
        value: async function () {
            ...
            e = new Set(this._dirty), e.forEach((function (t) {
                ...
                e._outputs.forEach(Ln)
            }));
            do {
                for (e.forEach((function (e) {
                    0 === e._indegree && n.push(e)
                })); t = n.pop();) Un(t), t._outputs.forEach(o), e.delete(t);
                e.forEach((function (t) {
                    kn(t) && (Dn(t, new RuntimeError("circular definition")), t._outputs.forEach(Mn), e.delete(t))
                }))
            } while (e.size);
